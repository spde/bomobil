...
function fetchPages(){
	...
	//Initiate initial AJAX req (first page)
		$.ajax({
			url: "proxy.php?url=http%3A%2F%2Fwww.boplats.se%2FHSS%2FObject%2Fobject_list.aspx%3Fcmguid%3D4e6e781e-5257-403e-b09d-7efc8edb0ac8%26objectgroup%3D1",
			dataType: 'html',
				...
				//Fetch additional pages (if applicable)
					...
					if (page_number > 1){
						for (i = 2; i <= page_number; i++){
							...
							$.ajax({ 
								url: "proxy.php?url=http%3A%2F%2Fwww.boplats.se%2FHSS%2FObject%2Fobject_list.aspx%3Fcmguid%3D4e6e781e-5257-403e-b09d-7efc8edb0ac8%26objectgroup%3D1&post=1&page="+i,
								dataType: 'html',
...
function extractObjectDeep(id, z){
	...
	//Initiate AJAX call to fetch more object data
		$.ajax({ 
			url: "proxy.php?url=http%3A%2F%2Fwww.boplats.se%2FHSS%2FObject%2Fobject_details.aspx%3Fobjectguid%3D" + id,
			dataType: 'html',
